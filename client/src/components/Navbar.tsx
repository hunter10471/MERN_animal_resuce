...
const Navbar = () => {
  ...
  return <nav className='relative flex justify-center text-white w-full' >
    ...
    <ul className={`flex flex-col items-center text-primary lg:text-white bg-white lg:bg-transparent lg:items-start  lg:flex-row justify-evenly gap-2 max-w-screen-xl transition-all duration-300 ease-in-out overflow-hidden ${toggle ? 'h-[320px] px-6 pt-10 opacity-100' : 'h-[0px] opacity-0'} lg:opacity-100 lg:h-auto w-full lg:p-8`}>
      {
